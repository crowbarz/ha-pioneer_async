...
OPTIONS_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_VOLUME_STEPS_ONLY, default=DEFAULT_VOLUME_STEPS_ONLY): bool,
    }
)
...
OPTIONS_DEFAULTS = {
    ...
    CONF_VOLUME_STEPS_ONLY: DEFAULT_VOLUME_STEPS_ONLY,
}
